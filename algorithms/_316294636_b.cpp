...
void _316294636_b::unloadContainerByPort(const string &portName, list<CargoOperation> &opList,
...
int _316294636_b::loadNewContainers(list<shared_ptr<Container>> &containerListToLoad,
                                    list<CargoOperation> &opList) {
    int result = 0;
...
void _316294636_b::rejectDestNotInRoute(list<shared_ptr<Container>> &loadList, list<CargoOperation> &opList) {
...
void
_316294636_b::rejectIllagalContainer(list<shared_ptr<Container>> &loadList, list<CargoOperation> &opList) {
    for (auto itr = loadList.begin(); itr != loadList.end();) {
...
int _316294636_b::rejectDoubleId(list<shared_ptr<Container>> &loadList, list<CargoOperation> &opList) {
...
int
_316294636_b::rejectAllBesideShipFull(list<shared_ptr<Container>> &loadList, list<CargoOperation> &opList) {
    int result = 0;
